...
describe('Mobile :- Test Suite to check whether Horrizontal bar is presnet', () => {
    it('Mobile :- check whether webpage is having horrizontal scroll bar or not - 1', () => {
      cy.viewport(393, 852);
    ...
    it('Mobile :- check whether webpage is having horrizontal scroll bar or not - 2', () => {
      cy.viewport(393, 852);
    ...
    it('Mobile :- check whether webpage is having horrizontal scroll bar or not - 3', () => {
      cy.viewport(393, 852);
