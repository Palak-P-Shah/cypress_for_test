...
describe('Test Suite To Test Multiple Conditions in Film Page', function() 
{
    ...
    it('Verify whether links at the top of Film page about ShadowAndAct are working or not', () => {
      Cypress.on('uncaught:exception', (err, runnable) => { return false; })
      cy.title().should('eq','Film - Blavity News')
      //set the viewport
      cy.viewport(1920, 1080);
    ...
    describe('To Test Whether Multiple sections do exist being visible in Film Page', function() 
    {
      it('get and check ShodowAndAct Header section is present or not present below the NavBar on the Film Page', () => {
        cy.viewport(1920, 1080);
        cy.title().should('eq','Film - Blavity News')
        //Cypress.on('uncaught:exception', (err, runnable) => { return false; })
        //cy.get('[class=""]')
      ...
      it('get and check links of ShadowAndAct App are present on the Film Page', () => {
        cy.viewport(1920, 1080);
        //cy.get('[class=""]')
        // ShodowAndAct Header section is present or not
      ...
      it('get and check Film Header Title before Articles is present on the Film Page', () => {
        cy.viewport(1920, 1080);
        cy.get('[class="heading-h1 mb-16"]').should('exist');
        cy.get('[class="heading-h1 mb-16"]').should('be.visible');  
        // cy.screenshot()
      })
      it('Check Newsletter Sign-up section after Articles and above footer is present on the Film Page', () => {
        cy.viewport(1920, 1080);
      ...
      it('Check Whether all article images have loaded or not on the Film Page', () => {
        cy.viewport(1920, 1080);
      ...
      it('Check Whether all article title have loaded or not on the Film Page', () => {
        cy.viewport(1920, 1080);
      ...
      it('Check Whether all article tags have loaded or not on the Film Page', () => {
        cy.viewport(1920, 1080);
      ...
      it('Check Whether all article have Date being loaded or not on the Film Page', () => {
        cy.viewport(1920, 1080);
        cy.get('[class="flex flex-wrap items-center mt-2 lg:flex-1"]')
        .eq(0)
        .find('p')
  ...
  it('get count of articles on the Film Page', () => {
      cy.viewport(1920, 1080);
      Cypress.on('uncaught:exception', (err, runnable) => { return false; })
      //cy.get('[class=""]')
      // ShodowAndAct Header section is present or not
    ...
    it('Check Whether Load More Stories Button is working on the Film Page with Number of Articles Populated', () => {
      cy.viewport(1920, 1080);
      Cypress.on('uncaught:exception', (err, runnable) => { return false; })
      // 
    ...
    it('should sign-up with email, within NewsLetter Sign-Up section in Film Page', () =>{
      cy.viewport(1920, 1080);    
